Shader "PlanetaryTerrain/BumpedPlanet"
{
	Properties 
	{
...
float4 Tex2D4=tex2D(_Normal1,IN.uv_Normal1.xy);
float4 Tex2D5=tex2D(_Normal2,IN.uv_Normal2.xy);
float4 Lerp3=lerp(Tex2D4,Tex2D5,Saturate0);
float4 Tex2D6=tex2D(_Normal3,IN.uv_Normal3.xy);
float4 Lerp4=lerp(Lerp3,Tex2D6,Saturate1);
float4 Tex2D7=tex2D(_Normal4,IN.uv_Normal4.xy);
